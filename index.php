...
<body>
	...
	<header>
		...
		<div class="alert alert-success role="alert">
		  ...
		  <strong>Hi There!</strong> Subscribe to us on <a href="https://youtube.com/minefilfat" target="_blank">YouTube</a>
		</div>
			...
			<div class="row">
			  <div class="col-sm-12 text-center">
				...
				<p class="lead" style="margin-top:75px;">
					...
					You can read about the latest news and/or app releases <a href="https://www.downloadmii.com/blog/">here</a>. We <span class="glyphicon glyphicon-heart" aria-hidden="true" style="color: red;"></span> Developers!
				</p>
			  </div>
			</div>
		  </div>
