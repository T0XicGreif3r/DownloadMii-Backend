<?php
	...
	*/
	...
	$matchingUsers = getArrayFromSQLQuery($mysqlConn, 'SELECT userId, nick, role FROM users WHERE LOWER(nick) = LOWER(?) AND password = ? LIMIT 2', 'ss', [$tryUserName, $hashedTryUserPass]);
