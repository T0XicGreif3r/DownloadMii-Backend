			...
			<div class="row">
			  <div class="col-sm-12 text-center">
				...
				<div class="row text-center">
				  <div class="row">
					  <div id="release" class="animated flipInY col-sm-5 col-xs-12 well clearfix" style="background: #25A4D6;box-shadow: 0 4px 2px -2px rgba(0,0,0,0.4);border:0;">
					  ...
					  <div id="beta" class="animated flipInY col-sm-5 col-xs-12 well clearfix" style="background: #25A4D6;box-shadow: 0 4px 2px -2px rgba(0,0,0,0.4);border:0;">
